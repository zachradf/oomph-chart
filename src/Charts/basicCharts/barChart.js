...
//     .domain(data.map((d) => d.x)) // Extract labels from the data
...
//     .attr('x', (d) => x(d.x)) // Set the x position using the x scale
//     .attr('y', (d) => y(d.y)) // Set the y position using the y scale
//     .attr('height', (d) => y(0) - y(d.y)) // Set the height based on the y scale
